...
This guide will help you integrate the Lighter Rust SDK into your project and start using it quickly.
...
```rust
use lighter_sdk::{CreateOrderRequest, LighterClient};
use std::env;
