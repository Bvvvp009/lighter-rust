...
fn main() {
    ...
    let sum = a.add(&b);
    let product = a.mul(&b);
    println!("Goldilocks: {} + {} = {}", a.to_canonical_u64(), b.to_canonical_u64(), sum.to_canonical_u64());
    println!("Goldilocks: {} * {} = {}", a.to_canonical_u64(), b.to_canonical_u64(), product.to_canonical_u64());
